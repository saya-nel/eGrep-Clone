...
public class RegEx {
	...
	static int UPPERCASE_START = 65;
	static int UPPERCASE_END = 90;
	static int LOWERCASE_START = 97;
	static int LOWERCASE_END = 122;
	...
	public static boolean isLetter(int c) {
		return (c >= UPPERCASE_START && c <= UPPERCASE_END) || (c >= LOWERCASE_START && c <= LOWERCASE_END);
	}
